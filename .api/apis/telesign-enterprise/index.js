...
var SDK = /** @class */ (function () {
    function SDK() {
        ...
        this.core = new core_1.default(this.spec, 'telesign-enterprise/1.0 (api/6.1.3)');
    }
    /**
     ...
     * later.  |
     */
    SDK.prototype.sendSMSVerifyCode = function (body) {
        return this.core.fetch('/v1/verify/sms', 'post', body);
    };
    /**
     ...
     *
     */
    SDK.prototype.getSMSVerifyStatus = function (metadata) {
        return this.core.fetch('/v1/verify/{reference_id}', 'get', metadata);
    };
    /**
     ...
     *
     */
    SDK.prototype.reportSMSVerifyCompletion = function (metadata) {
        return this.core.fetch('/v1/verify/completion/{reference_id}', 'put', metadata);
    };
    return SDK;
}());
